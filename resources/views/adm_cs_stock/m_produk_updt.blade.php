                                ...
                                <div class="row pb-1">
                                    ...
                                    <div class="col-6 mt-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="{stok}" aria-label="Username" aria-describedby="basic-addon1">
                                            <span class="input-group-text" id="basic-addon1">pcs</span>
                                        </div> 
                                        <div class="mb-3">
                                            <label for="" class="form-label">Terakhir Diubah</label>
                                            <input type="text" class="form-control" id="" placeholder="{Masukkan stok}">
                                        </div>
                                    </div>
                                    <div class="col-12">
